...
// Create a satellite street tile layer that will toggle background of our map and add it.
// NOTE: this first two lines provid the source for the code to call the kind of background needed like "dark-v10" or sny other of ther basic ones 
...
// NOTE: This overlay will be visible all the time.
let overlays = {
