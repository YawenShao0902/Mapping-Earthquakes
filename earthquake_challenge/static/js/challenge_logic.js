...
// Deliverable 3 Create the thired  tile layer that will be the background of our map.
...
// Add allEarthquake data as a layerGroup
// D1.1. Add a 2nd layer group for the tectonic plate data.
// D2.1. Add a 3ed layer group.
let allEarthquakes = new L.LayerGroup();
let tectonicPlates = new L.LayerGroup();
let majorEarthquakes = new L.LayerGroup();

// Create overlays variable with the layers above 
// D1.2. Add a reference to the tectonic plates group to the overlays object.
// D2.2. Add a reference to the 3ed layer group to the overlays object.
let overlays = {
